...
open class RefreshStateHeader: RefreshBaseHeader {
    ...
    open override func prepare() {
        ...
        set(title: BundleHelper.localizedString(key: RefreshConst.headerIdleText), forState: .idle)
        set(title: BundleHelper.localizedString(key: RefreshConst.headerPullingText), forState: .pulling)
    }
